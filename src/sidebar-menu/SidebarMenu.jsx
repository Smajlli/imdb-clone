...
import SidebarMenuListMovies from "./SidebarMenuListMovies";
import SidebarMenuListTvShows from "./SidebarMenuListTvShows";
import SidebarMenuListWatch from "./SidebarMenuListWatch";
import SidebarMenuListAwards from "./SidebarMenuListAwards";
import SidebarMenuListCelebs from "./SidebarMenuListCelebs";
import SidebarMenuListCommunity from "./SidebarMenuListCommunity";
import classNames from "classnames";

function SidebarMenu({handleSidebar}) {
    const [sidebarMenu, setSidebarMenu] = useState(false)
    const [sidebarMenuListMovies, setSidebarMenuListMovies] = useState(false);
    const [sidebarMenuListTvShows, setSidebarMenuListTvShows] = useState(false);
    const [sidebarMenuListWatch, setSidebarMenuListWatch] = useState(false);
    const [sidebarMenuListAwards, setSidebarMenuListAwards] = useState(false);
    const [sidebarMenuListCelebs, setSidebarMenuListCelebs] = useState(false);
    const [sidebarMenuListCommunity, setSidebarMenuListCommunity] = useState(false);

    const sidebarMenuContainerClasses = classNames('sidebarMenuContainer', {'activeSidebarMenuContainer' : sidebarMenu === true})

    const handleSidebarList = () => {
        handleSidebar();
    }

    const handleSidebarMenuClass = () => {
    ...
    return(
        ...
        <div className="sidebarMenu">
            <div className="sidebarMenuHamburgerContainer" onClick={handleSidebarMenuClass}>
                <span className="sidebarMenuHamburger"></span>
                <span className="sidebarMenuHamburger"></span>
                <span className="sidebarMenuHamburger"></span>
            </div>
                
            <div className={sidebarMenuContainerClasses}>
                    <div className="sidebarMenuClose" onClick={handleSidebarList}>
                        <svg
                ...
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                                height="28"
                                viewBox="0 0 24 24"
                            ...
                            <div className="sidebarCategoryHeading">Movies</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListMovies}
                        >
                            <path
                    ...
                    {sidebarMenuListMovies ? <SidebarMenuListMovies /> : null}
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                            ...
                            <div className="sidebarCategoryHeading">TV Shows</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListTvShows}
                        >
                            <path
                                d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z"
                                fill="currentColor"
                ...
                {sidebarMenuListTvShows ? <SidebarMenuListTvShows /> : null}
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                            ...
                            <div className="sidebarCategoryHeading">Watch</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListWatch}
                        >
                            <path
                                d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z"
                                fill="currentColor"
                ...
                {sidebarMenuListWatch ? <SidebarMenuListWatch/> : null}
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                            ...
                            <div className="sidebarCategoryHeading">Awards & Events</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListAwards}
                        >
                            <path
                                d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z"
                                fill="currentColor"
                ...
                {sidebarMenuListAwards ? <SidebarMenuListAwards /> : null}
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                            ...
                            <div className="sidebarCategoryHeading">Celebs</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListCelebs}
                        >
                            <path
                                d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z"
                                fill="currentColor"
                ...
                {sidebarMenuListCelebs ? <SidebarMenuListCelebs /> : null}
                <div className="sidebarMenuCategoryWrapper">
                        <div className="sidebarMenuCategory">
                            <svg
                                width="28"
                            ...
                            <div className="sidebarCategoryHeading">Communitiy</div>
                        </div>
                        <svg
                            width="24"
                            height="24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            className='sidebarMenuCategoryArrow'
                            onClick={handleSidebarMenuListCommunity}
                        >
                            <path
                                d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z"
                                fill="currentColor"
                ...
                {sidebarMenuListCommunity ? <SidebarMenuListCommunity /> : null}
            </div>
        </div>
        </>
    )
