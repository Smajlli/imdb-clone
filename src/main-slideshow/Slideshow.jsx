...
{/* <div className="Slideshow">
    <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt="movieImg" className="slideshowCover" />
    <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt="sldieshowImage" className="slideshowImage" />
    <div className="slideshowContentContainer">
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    <div className="slideshowGradient"></div>
</div> */}